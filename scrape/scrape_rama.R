...
findMatchRama <- function(union,verbose=TRUE){
  ...
  download.file(url,"rugbyrama.html",quiet=!verbose)
...
# union <- c("pro-d2","top-14","premiership","challenge-cup","champions-cup")
# whichMatches is a vector of integers
scraperama <- function(union,addMat=NULL,whichMatches=NULL,fetchdata=TRUE,fetchstats=TRUE,verbose=TRUE){
  ...
  id <- findMatchRama(union,verbose)
  ...
  for(idm in id){
    ...
    download.file(url,"match.html",quiet=!verbose)
    ...
    if(verbose) print(paste(round,thome,taway))
    
    ### Fetch data ###
    if(fetchdata){
      data <- findtypematch(weblines,"idalgo_content_action_logo_penalite_in","penalty",indlocal,thome,taway,round,date,data)
      data <- findtypematch(weblines,"idalgo_content_action_logo_penalite_out","missed penalty",indlocal,thome,taway,round,date,data)
      data <- findtypematch(weblines,"idalgo_content_action_logo_yellow","yellow",indlocal,thome,taway,round,date,data)
      data <- findtypematch(weblines,"idalgo_content_action_logo_red","red",indlocal,thome,taway,round,date,data)
      data <- findtypematch(weblines,"idalgo_content_action_logo_yellowred","orange",indlocal,thome,taway,round,date,data)
      data <- findtypematch(weblines,"idalgo_content_action_logo_drop_in","drop",indlocal,thome,taway,round,date,data)
      data <- findtypematch(weblines,"idalgo_content_action_logo_drop_out","missed drop",indlocal,thome,taway,round,date,data)
    ...
    ### Fetch stats ###
    if(fetchstats) stats <- rbind(stats,c("Score",thome,taway,scorehome,scoreaway,round,date))
  }
